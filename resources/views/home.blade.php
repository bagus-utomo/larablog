            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        ...
                        Judul dari artikel terbaru. <a href="#" class="font-semibold text-indigo-600"><span
                                class="absolute inset-0" aria-hidden="true"></span>Read more <span
                                aria-hidden="true">&rarr;</span></a>
                    </div>
                </div>
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Welcome to Lara<span
                            class="font-normal">Blog</span></h1>
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="#"
                            ...
                            started</a>
                        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Read articles <span
